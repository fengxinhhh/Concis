...
describe('Pagination', () => {
  ...
  it('test pagination with select show correctly', () => {
    ...
    component.find('.concis-pagination .concis-select').simulate('click');
    setTimeout(() => {
  ...
  it('test pagination with input show correctly', () => {
    const component = mount(
