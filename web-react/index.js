...
const p = n({}),
  ...
  m = r((e) => {
    ...
    return t.createElement(
      ...
      t.createElement(
        'button',
        { className: m, style: v, disabled: !!o, onClick: f },
...
var nn = l((e) => {
    ...
    return d
      ...
      : t.createElement(
          ...
          t.createElement(
            'div',
            { className: 'selected', onClick: S, style: O },
  ...
  rn = l((e) => {
    ...
    var e = a(() => (h && 'password' === l ? (S ? 'password' : 'text') : l || 'text'), [l, h, S]),
      P = a(() => {
        let e = { width: '170px' };
    ...
    return t.createElement(
      ...
      t.createElement(
        ...
        t.createElement(rn, {
          ...
          handleIptFocus: () => {
            C(!0), S(!0), (P.current.style.left = '0');
          },
          handleKeyDown: (e) => {
            var t = e;
            if (13 == t.keyCode)
        ...
        t.createElement(rn, {
          ...
          handleIptFocus: () => {
            C(!0), S(!0), (P.current.style.left = '190px');
          },
          handleKeyDown: (e) => {
            var t = e;
            if (13 == t.keyCode)
...
var fn = l((e) => {
    const { type: n, showRange: r, showClear: a, align: l, handleChange: s } = e,
      ...
      I = {
        result: { letterSpacing: 'normal', color: S || '#1890FF', width: '120px' },
        icon: { opacity: 1, marginLeft: '5px' },
        checkBox: { opacity: 1 },
        dayActive: {
          backgroundColor: S || '#1890FF',
          color: '#fff',
          fontWeight: 'bold',
          borderRadius: '5px',
        },
      ...
      : t.createElement(
          ...
          ('primary' == n || !n) &&
            t.createElement(
              ...
              {
                className: 'result',
                style: f ? Object.assign({}, I.result) : { '--hover-color': S || '#1890ff' },
                onClick: (e) => j(e),
              },
  ...
  gn = z(function (w, _) {
    !function () {
      ...
      function ol(e) {
        return al(e) ? e.match(m) || [] : e.split('');
      }
      var Vo = E({ '&amp;': '&', '&lt;': '<', '&gt;': '>', '&quot;': '"', '&#39;': "'" }),
        cl = (function a(e) {
          var I = (e = null == e ? Zi : cl.defaults(Zi.Object(), e, cl.pick(Zi, uo))).Array,
            F = e.Date,
            B = e.Error,
            R = e.Function,
            T = e.Math,
              ...
              if (d == $i || d == Di || (p && !t)) {
                ...
                l = (function (e, t) {
                  ...
                  switch (d) {
                    ...
                    case Hi:
                      return (
                        ((n = new (r = e).constructor(r.source, Gl.exec(r))).lastIndex =
                          r.lastIndex),
                        n
                      );
                    case Yi:
          ...
          function tt(e, t, n, r) {
            ...
            if (o) {
              n && (t = el(t, rl(n))),
                r ? ((i = No), (l = !1)) : 200 <= t.length && ((i = Ro), (l = !1), (t = new He(t)));
              e: for (; ++a < o; ) {
                var u = e[a],
                  f = null == n ? u : n(u),
                  u = r || 0 !== u ? u : 0;
              ...
              (null == e || null == t || (!i(e) && !i(t))
                ...
                : (function (e, t, n, r, a, i) {
                    ...
                    if (!(1 & n)) {
                      ...
                      if (l || s)
                        return a(l ? e.value() : e, s ? t.value() : t, n, r, (i = i || new S()));
                    }
                    if (o) {
                      i = i || new S();
                      var f = e,
          ...
          function wt(e) {
            return !(!E(e) || (K && K in e)) && (da(e) ? Q : eo).test(gr(e));
          }
          function _t(e) {
          ...
          function mn(t) {
            return function (e) {
              return Co(ii(Ga(e).replace(lo, '')), t, '');
            };
          }
          function vn(r) {
            return function () {
          ...
          function zn(e, t, n, r, a, i, l, o) {
            ...
            return (
              ...
              (r = j[3]),
              (a = j[4]),
              !(o = j[9] = j[9] === Ai ? (c ? 0 : e.length) : A(j[9] - O, 0)) &&
                24 & t &&
                (t &= -25),
              (l =
                t && 1 != t
          ...
          function Pn(e, t, n, r, a, i) {
            return E(e) && E(t) && (i.set(t, e), jt(e, t, Ai, Pn, i), i.delete(t)), e;
          }
          function Mn(e) {
            return ya(e) ? Ai : e;
          }
          function Ln(e, t, n, r, a, i) {
            ...
            var s = -1,
              u = !0,
              f = 2 & n ? new He() : Ai;
            for (i.set(e, t), i.set(t, e); ++s < o; ) {
              var h,
                d = e[s],
                p = t[s];
              if ((h = r ? (l ? r(p, d, s, t, e, i) : r(d, p, s, e, t, i)) : h) !== Ai) {
                if (h) continue;
                u = !1;
                break;
              }
              if (f) {
                if (
                  !So(t, function (e, t) {
                    return !Ro(f, t) && (d === e || a(d, e, n, r, i)) && f.push(t);
                  })
                ) {
                  u = !1;
                  break;
                }
              } else if (d !== p && !a(d, p, n, r, i)) {
                u = !1;
                break;
              }
            }
          ...
          ((F && j(new F(new ArrayBuffer(1))) != Ui) ||
            (_e && j(new _e()) != Ri) ||
            (ke && j(ke.resolve()) != ml) ||
            (Ne && j(new Ne()) != Yi) ||
            (e && j(new e()) != Wi)) &&
          ...
          function Na(e) {
            ...
            var t;
            {
              ...
              return ((t = j(e)) == Ri ? Wo : t == Yi ? Uo : Va)(e);
            }
          }
          function Ca(e) {
            return e
          ...
          function Ga(e) {
            return (e = d(e)) && e.replace(ro, Ho).replace(oo, '');
          }
          ...
          return (
            ...
            (p.every = function (e, t, n) {
              return (L(e) ? _o : at)(e, u((t = n && f(e, t, n) ? Ai : t), 3));
            }),
            (p.find = Rr),
            (p.findIndex = vr),
            ...
            (p.some = function (e, t, n) {
              return (L(e) ? So : Rt)(e, u((t = n && f(e, t, n) ? Ai : t), 3));
            }),
            ...
            (p.trimEnd = function (e, t, n) {
              if ((e = d(e)) && (n || t === Ai)) return e.replace(ql, '');
              if (!e || !(t = s(t))) return e;
              n = ol(e);
              return tn(n, 0, $o(n, ol(t)) + 1).join('');
            }),
            (p.trimStart = function (e, t, n) {
              if ((e = d(e)) && (n || t === Ai)) return e.replace(Yl, '');
              if (!e || !(t = s(t))) return e;
              n = ol(e);
                ...
                if ((i && (t += r.length - t), ba(n))) {
                  if (e.slice(t).search(n)) {
                    var l,
                      o = r;
                    for (
                      (n = n.global ? n : $(n.source, d(Gl.exec(n)) + 'g')).lastIndex = 0;
                      (l = n.exec(o));
            ...
            (Se[xn(Ai, 2).name] = [{ name: 'wrapper', func: Ai }]),
      ...
      S = (e = h) =>
        e.map((n, e) => {
          return t.createElement(
            ...
            (null == (e = null == n ? void 0 : n.children) ? void 0 : e.length) && S(n.children),
          );
        });
    return t.createElement(
      d,
