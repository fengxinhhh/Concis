...
import Rate from '../../../packages/concis-react/src/Rate';
...
describe('Rate', () => {
  it('test base Rate Component correctly', () => {
    ...
    expect(component.find('.rate .rate-container .rate-box')).toHaveLength(5);
    component.find('.rate .rate-container .rate-box').at(1).simulate('click');
  ...
  it('test default show num correctly', () => {
    ...
    expect(component.find('.rate .rate-container .rate-box')).toHaveLength(4);
  });
