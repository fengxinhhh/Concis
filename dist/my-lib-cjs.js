...
var ge = a.forwardRef(function (e, t) {
  var n,
    ...
    b = E(
      m,
      (h((n = {}), ''.concat(m, '-').concat(i.name), !!i.name),
      h(n, ''.concat(m, '-spin'), !!l || 'loading' === i.name),
      n),
      r,
    ),
    x = c;
...
var at = a.forwardRef(rt),
  ...
  lt = function (e, t) {
    return a.createElement(me, g(g({}, e), {}, { ref: t, icon: it }));
  };
  ...
  Yt = x(function (e, t) {
    (function () {
      ...
      var pn = (function e(t) {
        ...
        function Ir(e, t, r) {
          for (
            var a = r ? zt : It, i = e[0].length, l = e.length, o = l, c = we(l), u = 1 / 0, s = [];
            o--;
        ...
        function Lr(e) {
          return !(!to(e) || ((t = e), Fe && Fe in t)) && (Xl(e) ? We : ve).test(Fi(e));
          var t;
        }
        function Dr(e) {
        ...
        return (
          ...
          ($n.min = function (e) {
            return e && e.length ? mr(e, ic, Fr) : n;
          }),
          ($n.minBy = function (e, t) {
            return e && e.length ? mr(e, ui(t, 2), Fr) : n;
          }),
          ($n.stubArray = vc),
          ($n.stubFalse = yc),
          ...
          ? f(!0, (t) => {
              (e = document.querySelector('.collapse-item-content').scrollHeight + 30),
                p
                  ...
                  : h(
                      (e) => (v && v([...[...e, Number(l)].sort()]), [...[...e, Number(l)].sort()]),
                    ),
                u(e);
            })
          : ((e = document.querySelector('.collapse-item-content').scrollHeight + 30),
