  ...
  */
  ...
  function q(e) {
    for (
      ...
      var i = B(r),
        l = T(z({ h: $(i, a, !0), s: Y(i, a, !0), v: W(i, a, !0) }));
      n.push(l);
    }
    n.push(T(r));
    for (var o = 1; o <= 4; o += 1) {
      var c = B(r),
        u = T(z({ h: $(c, o), s: Y(c, o), v: W(c, o) }));
      n.push(u);
    }
    return 'dark' === t.theme
      ? R.map(function (e) {
          var r = e.index,
            a = e.opacity;
          return T(F(z(t.backgroundColor || '#141414'), z(n[r]), 100 * a));
        })
      : n;
  }
  var H = {
  ...
  var Ie = i.forwardRef(je),
    ...
    Ae = function (e, t) {
      return i.createElement(ye, m(m({}, e), {}, { ref: t, icon: ze }));
    };
      ...
      (function () {
        ...
        var pn = (function e(t) {
          ...
          function dr(e, t, n, r) {
            ...
            if (!o) return c;
            n && (t = At(t, Kt(n))),
              r ? ((i = zt), (l = !1)) : t.length >= 200 && ((i = Zt), (l = !1), (t = new Kn(t)));
            e: for (; ++a < o; ) {
              var s = e[a],
                f = null == n ? s : n(s);
          ...
          function zr(e, t, r) {
            var a = null == (e = Si(e, (t = xa(t, e)))) ? e : e[Bi(Zi(t))];
                          ...
                          (f = u),
                            h || p || g
                              ? Hl(c)
                                ...
                                : (f = [])
                              : io(u) || ql(u)
                              ? ((f = c), ql(c) ? (f = bo(c)) : (to(c) && !Xl(c)) || (f = vi(u)))
                              : (d = !1);
                        }
          ...
          function Ur(e, t, n, r) {
            var a = r ? $t : Ft,
              ...
              l = t.length,
              o = e;
            for (e === t && (t = Ia(t)), n && (o = At(e, Kt(n))); ++i < l; )
          ...
          function da(e, t) {
            return null == (e = Si(e, (t = xa(t, e)))) || delete e[Bi(Zi(t))];
          }
          function ha(e, t, n, r) {
          ...
          function Va(e, t, r, a, i, l, u, s, f, d) {
            ...
            var p = [e, t, i, h ? l : n, h ? u : n, h ? n : l, h ? n : u, s, f, d],
              g = r.apply(n, p);
            return _i(e) && zi(g, p), (g.placeholder = a), Mi(g, e, t);
          }
          function Ka(e) {
            var t = Oe[e];
            return function (e, n) {
          ...
          function ni(e, t, r, a, i, l) {
            ...
            for (l.set(e, t), l.set(t, e); ++f < c; ) {
              var p = e[f],
                g = t[f];
              if (a) var m = o ? a(g, p, f, t, e, l) : a(p, g, f, e, t, l);
              if (m !== n) {
                if (m) continue;
                d = !1;
                break;
              ...
              if (h) {
                if (
                  !Dt(t, function (e, t) {
                    if (!Zt(h, t) && (p === e || i(p, e, r, a, l))) return h.push(t);
                  })
                ) {
                  d = !1;
                  break;
          ...
          var Vi = Zr(function (e) {
            ...
            Ki = Zr(function (e) {
              var t = Zi(e),
                r = At(e, ya);
              return (
                t === Zi(r) ? (t = n) : r.pop(), r.length && r[0] === e[0] ? Ir(r, ui(t, 2)) : []
              );
            }),
            Gi = Zr(function (e) {
              var t = Zi(e),
          ...
          var _l = Zr(function (e, t, n) {
              ...
              return (
                hr(e, function (e) {
                  i[++r] = a ? kt(t, e, n) : zr(e, t, n);
                }),
                i
              );
            }),
            wl = Aa(function (e, t, n) {
              lr(e, n, t);
            });
          function kl(e, t) {
            return (Hl(e) ? At : Fr)(e, ui(t, 3));
          }
          var Nl = Aa(
            function (e, t, n) {
              e[n ? 0 : 1].push(t);
          ...
          function Al(e, t, a) {
            ...
            function x() {
              ...
              if (((i = arguments), (l = this), (s = e), r)) {
                if (u === n) return m(s);
                if (h) return (u = Ai(y, t)), g(s);
              }
              return u === n && (u = Ai(y, t)), c;
            }
            return (
              (t = yo(t) || 0),
              to(a) &&
          ...
          var Rl = Ea(function (e, t) {
              var n = (t = 1 == t.length && Hl(t[0]) ? At(t[0], Kt(ui())) : At(yr(t, 1), Kt(ui())))
                .length;
          ...
          return (
            ...
            ($n.throttle = function (e, t, n) {
              ...
              return (
                ...
                Al(e, t, { leading: a, maxWait: t, trailing: i })
              );
            }),
            ($n.thru = pl),
            ($n.toArray = po),
            ...
            ($n.toPairsIn = $o),
            ($n.toPath = function (e) {
              return Hl(e) ? At(e, Bi) : uo(e) ? [e] : Ia(Ri(xo(e)));
            }),
            ($n.toPlainObject = bo),
            ...
            ($n.repeat = function (e, t, r) {
              return (t = (r ? xi(e, t, r) : t === n) ? 1 : mo(t)), Gr(xo(e), t);
            }),
            ($n.replace = function () {
              var e = arguments,
                t = xo(e[0]);
          ...
          ? m && !s
            ? f(!0, (t) => {
                (e = document.querySelector('.collapse-item-content').scrollHeight + 30),
                  p
                    ? (h([Number(l)]), v && v([Number(l)]))
                    : h(
                        (e) => (
                          v && v([...[...e, Number(l)].sort()]), [...[...e, Number(l)].sort()]
                        ),
                      ),
                  u(e);
              })
            : ((e = document.querySelector('.collapse-item-content').scrollHeight + 30),
              p
                ? (h([Number(l)]), v && v([Number(l)]))
                : h((e) => (v && v([...[...e, Number(l)].sort()]), [...[...e, Number(l)].sort()])),
              u(e))
          : ((e = 0),
            h(
              (e) => (
      ...
      p = t.useMemo(() => {
        ...
        return (
          Object.keys(f).length > 0
            ...
            : i && ((e.width = `${i}px`), (e.height = `${i}px`), (e.fontSize = i / 3 + 'px')),
          l && 'square' === l && (e.borderRadius = '5px'),
          e
        );
      }, [r, l, i, f]),
      g = t.useMemo(
        () =>
          'square' == l ? { right: '-2px', bottom: '-2px' } : { right: '2px', bottom: '-2px' },
        [c],
      ),
      m = () => {
        s && s();
