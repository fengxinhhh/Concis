!(function (e, t) {
  ...
  const c = t.forwardRef((e) => {
    ...
    return l.default.createElement(
      'div',
      { className: 'button', style: { width: r + 'px', height: a + 'px' } },
      l.default.createElement(
        'button',
        { className: h, style: p, disabled: !!i, onClick: s },
        u && l.default.createElement('div', { className: 'loading1' }),
        f,
      ),
    );
  });
  ...
  const u = t.memo((e) => {
    const { children: n, fontSize: r, borderColor: a, align: i, dashed: o } = e,
      c = t.useMemo(
        () =>
          'left' === i
            ? { justifyContent: 'left' }
    ...
    return l.default.createElement(
      ...
      l.default.createElement(
        ...
        n && l.default.createElement('span', { className: 'line-text', style: s }, n),
      ),
    );
  });
  var s = t.memo((e) => {
    const { children: n, extraStyle: r } = e,
      a = t.useMemo(() => r || {}, [r]);
    return l.default.createElement('div', { className: 'layout', style: a }, n);
  });
  var f = t.memo((e) => {
    const { children: n, extraStyle: r } = e,
      a = t.useMemo(() => r || {}, [r]);
    return l.default.createElement('div', { className: 'header', style: a }, n);
  });
  var d = t.memo((e) => {
    const { row: n, extraStyle: r } = e,
      a = t.useMemo(() => (n ? { width: `${n}0%` } : {}), [n]),
      i = t.useMemo(() => r || {}, [r]);
    return l.default.createElement(
      'div',
      { className: 'slider', style: Object.assign(Object.assign({}, a), i) },
      e.children,
    );
  });
  var h = t.memo((e) => {
    const { children: n, row: r, extraStyle: a } = e,
  ...
  var p = t.memo((e) => {
      const { children: n, extraStyle: r } = e,
        a = t.useMemo(() => r || {}, [r]);
      return l.default.createElement('div', { className: 'footer', style: a }, n);
    }),
    m = t.createContext({});
  function g(e, t, n) {
    return (
  ...
  */
    ...
    return (
      'string' == typeof e &&
        (e = (function (e) {
          ...
          if ((n = D.hex8.exec(e)))
            return { r: z(n[1]), g: z(n[2]), b: z(n[3]), a: I(n[4]), format: t ? 'name' : 'hex8' };
          if ((n = D.hex6.exec(e)))
      ...
      'object' == typeof e &&
        (B(e.r) && B(e.g) && B(e.b)
          ? ((t = e.r),
            (n = e.g),
            (r = e.b),
            (a = { r: 255 * C(t, 255), g: 255 * C(n, 255), b: 255 * C(r, 255) }),
            (u = !0),
            ...
            (a = (function (e, t, n) {
              ...
              if (((e = C(e, 360)), (t = C(t, 100)), (n = C(n, 100)), 0 === t))
                ...
                var i = n < 0.5 ? n * (1 + t) : n + t - n * t,
                  o = 2 * n - i;
                (r = j(o, i, e + 1 / 3)), (a = j(o, i, e)), (l = j(o, i, e - 1 / 3));
              }
  ...
  function J(e) {
    for (
      ...
      var l = F(r),
        i = $(M({ h: q(l, a, !0), s: Y(l, a, !0), v: H(l, a, !0) }));
      n.push(i);
    }
    n.push($(r));
    for (var o = 1; o <= 4; o += 1) {
      var c = F(r),
        u = $(M({ h: q(c, o), s: Y(c, o), v: H(c, o) }));
      n.push(u);
    }
    return 'dark' === t.theme
      ? T.map(function (e) {
          var r = e.index,
            a = e.opacity;
          return $(W(M(t.backgroundColor || '#141414'), M(n[r]), 100 * a));
        })
      : n;
  }
  var U = {
  ...
  function le(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
      n = ne(t);
    return Array.from(ae.get(n).children).find(function (n) {
      return 'STYLE' === n.tagName && n.getAttribute(te(t)) === e;
    });
  }
  function ie(e, t) {
    ...
    var s = re(e, n);
    return s.setAttribute(te(n), t), s;
  }
  function oe(e) {
    return (
      'object' === N(e) &&
  ...
  var me = function (e) {
    ...
    return (
      d &&
        ...
        (d = y(y({}, d), {}, { icon: d.icon(f.primaryColor, f.secondaryColor) })),
      ue(
        d.icon,
        'svg-'.concat(d.name),
        y(
  ...
  (me.displayName = 'IconReact'),
    ...
    (me.setTwoToneColors = function (e) {
      var t = e.primaryColor,
        n = e.secondaryColor;
      (pe.primaryColor = t), (pe.secondaryColor = n || se(t)), (pe.calculated = !!n);
    });
  var ge = me;
  function ve(e) {
    var t = x(fe(e), 2),
      n = t[0],
      r = t[1];
    return ge.setTwoToneColors({ primaryColor: n, secondaryColor: r });
  }
  var ye = ['className', 'icon', 'spin', 'rotate', 'tabIndex', 'onClick', 'twoToneColor'];
  ve('#1890ff');
  var be = i.forwardRef(function (e, t) {
    var n,
      ...
      s = e.twoToneColor,
      f = E(e, ye),
      d = i.useContext(m).prefixCls,
      h = void 0 === d ? 'anticon' : d,
      p = k(
        h,
        (g((n = {}), ''.concat(h, '-').concat(a.name), !!a.name),
        g(n, ''.concat(h, '-spin'), !!l || 'loading' === a.name),
        n),
        r,
      ),
      v = c;
    ...
    return i.createElement(
      'span',
      y(
        y({ role: 'img', 'aria-label': a.name }, f),
        {},
        { ref: t, tabIndex: v, onClick: u, className: p },
      ),
      i.createElement(ge, { icon: a, primaryColor: w, secondaryColor: N, style: b }),
    );
  });
  ...
  var xe = be,
    ...
    _e = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: Ee }));
    };
  ...
  var we = i.forwardRef(_e),
    ...
    Ne = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: ke }));
    };
  Ne.displayName = 'CaretLeftOutlined';
  var Ce = i.forwardRef(Ne),
    Se = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '0 0 1024 1024', focusable: 'false' },
    ...
    Oe = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: Se }));
    };
  Oe.displayName = 'CaretRightOutlined';
  var je = i.forwardRef(Oe),
    Ie = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '0 0 1024 1024', focusable: 'false' },
    ...
    ze = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: Ie }));
    };
  ...
  var Ae = i.forwardRef(ze),
    ...
    Pe = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: Me }));
    };
  Pe.displayName = 'CheckCircleFilled';
  var Le = i.forwardRef(Pe),
    Re = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
    ...
    De = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: Re }));
    };
  De.displayName = 'CheckOutlined';
  var Be = i.forwardRef(De),
    Te = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
    ...
    Fe = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: Te }));
    };
  Fe.displayName = 'CloseCircleFilled';
  var $e = i.forwardRef(Fe),
    We = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
    ...
    qe = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: We }));
    };
  qe.displayName = 'CloseOutlined';
  var Ye = i.forwardRef(qe),
    He = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
    ...
    Je = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: He }));
    };
  Je.displayName = 'DoubleLeftOutlined';
  var Ue = i.forwardRef(Je),
    ...
    Ke = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: Ve }));
    };
  Ke.displayName = 'DoubleRightOutlined';
  var Ge = i.forwardRef(Ke),
    Ze = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
    ...
    Xe = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: Ze }));
    };
  ...
  var Qe = i.forwardRef(Xe),
    ...
    tt = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: et }));
    };
  tt.displayName = 'EllipsisOutlined';
  var nt = i.forwardRef(tt),
    rt = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
    ...
    at = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: rt }));
    };
  at.displayName = 'ExclamationCircleFilled';
  var lt = i.forwardRef(at),
    it = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
    ...
    ot = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: it }));
    };
  ot.displayName = 'EyeOutlined';
  var ct = i.forwardRef(ot),
    ut = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
    ...
    st = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: ut }));
    };
  st.displayName = 'FieldTimeOutlined';
  var ft = i.forwardRef(st),
    dt = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
    ...
    ht = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: dt }));
    };
  ht.displayName = 'LeftCircleOutlined';
  var pt = i.forwardRef(ht),
    mt = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
    ...
    gt = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: mt }));
    };
  gt.displayName = 'LeftOutlined';
  var vt = i.forwardRef(gt),
    yt = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '0 0 1024 1024', focusable: 'false' },
    ...
    bt = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: yt }));
    };
  bt.displayName = 'LoadingOutlined';
  var xt = i.forwardRef(bt),
    Et = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
  ...
  var wt = i.forwardRef(_t),
    ...
    Nt = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: kt }));
    };
  Nt.displayName = 'RightCircleOutlined';
  var Ct = i.forwardRef(Nt),
    St = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
    ...
    Ot = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: St }));
    };
  Ot.displayName = 'RightOutlined';
  var jt = i.forwardRef(Ot),
    It = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
  ...
  zt.displayName = 'RollbackOutlined';
  var At = i.forwardRef(zt),
    Mt = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '64 64 896 896', focusable: 'false' },
  ...
  Pt.displayName = 'SearchOutlined';
  var Lt = i.forwardRef(Pt),
    Rt = {
      icon: {
        tag: 'svg',
        attrs: { viewBox: '0 0 1024 1024', focusable: 'false' },
  ...
  var Bt = i.forwardRef(Dt),
    ...
    Ft = function (e, t) {
      return i.createElement(xe, y(y({}, e), {}, { ref: t, icon: Tt }));
    };
  Ft.displayName = 'UpOutlined';
  var $t = i.forwardRef(Ft);
  var Wt = t.memo((e) => {
    const {
        style: n,
    ...
    return l.default.createElement(
      ...
      c &&
        l.default.createElement(
          'div',
          { className: 'jumpBox' },
          l.default.createElement('span', null, '跳至'),
          ...
          l.default.createElement('span', null, '页'),
        ),
    );
  });
  var qt = t.memo((e) => {
    ...
    return c
      ...
      : l.default.createElement(
          ...
          l.default.createElement(
            ...
            o ? l.default.createElement(xt, null) : l.default.createElement(Qe, null),
          ),
          l.default.createElement(
            'div',
            { className: 'selectOptions', style: y, ref: g },
        ...
        ('num' === a &&
          l.default.createElement(
            ...
            l.default.createElement($t, {
              ...
              onClick: () => {
                if ('num' === a && NaN == Number(x)) return E('');
                const e = f || 1;
  ...
  var Jt = t.memo((e) => {
    const { children: n, value: r, canAddOption: a, boxStyle: i, onChange: o } = e,
      [c, u] = t.useState(r || 0),
      [s, f] = t.useState(n),
      [d, h] = t.useState(''),
      [p, m] = t.useState(a && !1),
      ...
      a
        ? i
          ? l.default.createElement(
              ...
              p && l.default.createElement(Yt, { handleKeyDown: y, handleIptChange: b }),
            )
          : l.default.createElement(
              'div',
              { className: 'addOption' },
              l.default.createElement(
                ...
                l.default.createElement('span', { className: 'radioLabel' }, 'More...'),
                l.default.createElement('input', {
                  className: 'radio',
                  type: 'radio',
                  readOnly: !0,
    ...
    const m = (e, t, n) => (
        e.forEach((e) => {
          ...
          e.children &&
            ...
            m(e.children, t, e.level && 1 == e.level ? e.key : ''));
        }),
        t
      ),
      g = (e) => {
          ...
          return e.children.map((t) =>
            l.default.createElement(
              ...
              l.default.createElement(
                'div',
                {
                  className: a == t.key ? 'activeMenuOptions' : 'childMenuOptions',
                ...
                l.default.createElement(
                  ...
                  {
                    className:
                      t.children && -1 !== t.children.findIndex((e) => e.key == a)
                        ? 'activeFatherTitle'
                        : 'fatherTitle',
                    onClick: (n) =>
                      ((e, t, n) => {
                  ...
                  l.default.createElement('span', null, t.label),
                  t.children &&
                    ('50px' == v(t.key).height
                      ? l.default.createElement(we, null)
                      : l.default.createElement(Ae, null)),
                ),
                l.default.createElement(
                  'div',
          ...
          l.default.createElement(
            ...
            l.default.createElement(
              ...
              l.default.createElement(
                'div',
                { className: 'left' },
                l.default.createElement('i', null, e.icon),
            ...
            l.default.createElement(l.default.Fragment, null, e.children && b(e)),
          ),
        ),
      ),
    );
    ...
    return l.default.createElement(
      ...
      l.default.createElement(
        ...
        l.default.createElement(Yt, {
          ...
          handleIptFocus: () => {
            w(!0), N(!0), (O.current.style.left = '0');
          },
          handleKeyDown: (e) =>
            ((e) => {
              if (13 == e.keyCode)
        ...
        l.default.createElement(Bt, { style: { color: '#cccccc', fontSize: '20px' } }),
        l.default.createElement(Yt, {
          placeholder: '请输入结束日期',
          defaultValue: d || `${c.endYear}-${c.endMonth}-${c.endDay}`,
          handleIptChange: (e) => h(e),
          handleIptFocus: () => {
            w(!0), N(!0), (O.current.style.left = '190px');
          },
          handleKeyDown: (e) =>
            ((e) => {
              if (13 == e.keyCode)
        ...
        l.default.createElement('div', { className: 'activeBorder', ref: O }),
      ),
      k &&
        l.default.createElement(
          'div',
          ...
          l.default.createElement(
            ...
            l.default.createElement(
              ...
              l.default.createElement(
                'div',
                null,
                l.default.createElement(jt, {
                  style: { cursor: 'pointer' },
                  onClick: () => A('start'),
                }),
                l.default.createElement(Ge, {
                  style: { marginLeft: '10px', cursor: 'pointer' },
                  onClick: () => I('start'),
                }),
              ),
            ...
            l.default.createElement(
              'div',
              { className: 'week' },
              l.default.createElement('div', null, '一'),
              l.default.createElement('div', null, '二'),
              l.default.createElement('div', null, '三'),
              l.default.createElement('div', null, '四'),
              l.default.createElement('div', null, '五'),
              l.default.createElement('div', null, '六'),
              l.default.createElement('div', null, '日'),
            ),
            l.default.createElement(
              'div',
              { className: 'day-list' },
  ...
  var Zt = t.memo((e) => {
    const { type: n, showRange: r, showClear: a, align: i, handleChange: o } = e,
      [c, u] = t.useState(!1),
      [s, f] = t.useState(!1),
      [d, h] = t.useState({
      ...
      : l.default.createElement(
          ...
          ('primary' == n || !n) &&
            l.default.createElement(
              ...
              l.default.createElement('span', null, d.year, '-', d.month, '-', d.day),
              l.default.createElement(
                'div',
          ...
          s &&
            l.default.createElement(
              ...
              l.default.createElement(
                'div',
                { className: 'top-bar' },
                l.default.createElement('b', { className: 'year', onClick: () => b(2) }, d.year),
                l.default.createElement(
                  'b',
                ...
                l.default.createElement(
                  ...
                  l.default.createElement(Ye, null),
                ),
              ),
              l.default.createElement(
                'div',
                ...
                2 == y &&
                  l.default.createElement(
                    ...
                    l.default.createElement(
                      ...
                      l.default.createElement('span', null, _[0], '-', _[8]),
                      l.default.createElement(Ge, {
                        style: { cursor: 'pointer' },
                        onClick: () => {
                          w((e) => [...e.map((e) => e + 9)]);
                ...
                0 == y &&
                  l.default.createElement(
                    ...
                    l.default.createElement(
                      ...
                      l.default.createElement('span', null, '今天'),
                ...
                (1 == y || 2 == y) &&
                  l.default.createElement(
                    ...
                    l.default.createElement(
                      ...
                      l.default.createElement(At, null),
                    ),
                  ),
              ),
            ),
  ...
  var Xt = t.memo((e) => {
    ...
    return l.default.createElement('div', { className: 'lazyLoad', ref: o }, a && n);
  });
  var Qt = t.memo((e) => {
          ...
          r.map((e, t) =>
            l.default.createElement(
              ...
              t + 1 < n
                ...
                : l.default.createElement('span', { className: a(t + 1) }, t + 1),
              l.default.createElement(
                'div',
                ...
                l.default.createElement(
                  ...
                  l.default.createElement('span', { className: 'sub-title' }, e.props.subTitle),
                ),
                l.default.createElement(
                  'div',
                  {
    ...
    tn = w(function (e, t) {
      (function () {
        var n,
          ...
          at = -1,
          lt = {};
        (lt[L] = lt[R] = lt[D] = lt[B] = lt[T] = lt[F] = lt[$] = lt[W] = lt[q] = !0),
          (lt[g] =
            lt[v] =
            lt[M] =
            lt[y] =
        ...
        var ot = {
          ...
          ct = parseFloat,
          ut = parseInt,
          st = 'object' == typeof _ && _ && _.Object === Object && _,
        ...
        var pn = (function e(t) {
          var _,
            ...
            Be = 0,
            Te = (_ = /[^.]+$/.exec((Le && Le.keys && Le.keys.IE_PROTO) || ''))
              ? 'Symbol(src)_1.' + _
              : '',
            Fe = Pe.toString,
            $e = Re.call(Oe),
            ...
            He = t.Symbol,
            Je = t.Uint8Array,
            Ue = Ye ? Ye.allocUnsafe : n,
            Ve = on(Oe.getPrototypeOf, Oe),
            Ke = Oe.create,
          ...
          function $n(e) {
            if (no(e) && !Hi(e) && !(e instanceof Hn)) {
              ...
              if (De.call(e, '__wrapped__')) return Fl(e);
            }
            return new Yn(e);
          }
          var Wn = (function () {
          ...
          function Qn(e, t) {
            return Rl(Ia(e), cr(t, 0, e.length));
          }
          function er(e) {
            return Rl(Ia(e));
          }
          ...
          function nr(e, t, r) {
            var a = e[t];
            (De.call(e, t) && $i(a, r) && (r !== n || t in e)) || ir(e, t, r);
          }
          function rr(e, t) {
          ...
          function ur(e, t, r, a, l, i) {
            ...
            var m = f ? n : (s ? (u ? ll : al) : u ? Po : Mo)(e);
            return (
              Ct(m || e, function (n, a) {
                m && (n = e[(a = n)]), nr(o, a, ur(n, t, r, a, e, i));
              }),
              o
            );
          }
          ...
          function Ir(e, t, r) {
            ...
            e: for (; ++d < l && s.length < u; ) {
              var p = f[d],
                m = t ? t(p) : p;
              if (((p = r || 0 !== p ? p : 0), !(h ? Zt(h, m) : a(s, m, r)))) {
                for (o = i; --o; ) {
                  var g = c[o];
                  if (!(g ? Zt(g, m) : a(e[o], m, r))) continue e;
                }
                h && h.push(m), s.push(p);
              }
            }
          ...
          function zr(e, t, r) {
            var a = null == (e = Ol(e, (t = xa(t, e)))) ? e : e[Bl(Zl(t))];
                ...
                : (function (e, t, r, a, l, i) {
                    ...
                    if (!(1 & r)) {
                      var p = f && De.call(e, '__wrapped__'),
                        m = d && De.call(t, '__wrapped__');
                      if (p || m) {
                        var E = p ? e.value() : e,
                          _ = m ? t.value() : t;
                        return i || (i = new Gn()), l(E, _, r, a, i);
                      }
                    }
                    if (!h) return !1;
                    return (
                      ...
                      (function (e, t, r, a, l, i) {
                        ...
                        for (; f--; ) {
                          var d = c[f];
                          if (!(o ? d in t : De.call(t, d))) return !1;
                        }
                        var h = i.get(e);
                        ...
                        for (; ++f < u; ) {
                          var g = e[(d = c[f])],
                            v = t[d];
                          if (a) var y = o ? a(v, g, d, t, e, i) : a(g, v, d, e, t, i);
                          if (!(y === n ? g === v || l(g, v, r, a, i) : y)) {
                            p = !1;
                            break;
                          }
                          m || (m = 'constructor' == d);
                          ...
                          (f = u),
                            h || p || m
                              ? Hi(c)
                                ...
                                : (f = [])
                              : lo(u) || Yi(u)
                              ? ((f = c), Yi(c) ? (f = bo(c)) : (to(c) && !Xi(c)) || (f = vl(u)))
                              : (d = !1);
                        }
          ...
          function da(e, t) {
            return null == (e = Ol(e, (t = xa(t, e)))) || delete e[Bl(Zl(t))];
          }
          function ha(e, t, n, r) {
          ...
          function xa(e, t) {
            return Hi(e) ? e : El(e, t) ? [e] : Dl(xo(e));
          }
          var Ea = Zr;
          function _a(e, t, r) {
            var a = e.length;
          ...
          function La(e) {
            return function (t, n, r) {
              for (var a = -1, l = Oe(t), i = r(t), o = i.length; o--; ) {
                var c = i[e ? o : ++a];
          ...
          function Fa(e) {
            return rl(function (t) {
              ...
              for (e && t.reverse(); l--; ) {
                ...
                if (i && !c && 'wrapper' == ol(o)) var c = new Yn([], !0);
              }
              for (l = c ? l : a; ++l < a; ) {
                var u = ol((o = t[l])),
                  s = 'wrapper' == u ? il(o) : n;
          ...
          function $a(e, t, r, a, l, i, o, c, s, f) {
            ...
            return function n() {
              ...
              if (m)
                var x = cl(n),
                  E = en(y, x);
              if ((a && (y = Oa(y, a, l, m)), i && (y = ja(y, i, o, m)), (u -= E), m && u < f)) {
                var _ = cn(y, x);
          ...
          function Va(e, t, r, a, l, i, u, s, f, d) {
            ...
            var p = [e, t, l, h ? i : n, h ? u : n, h ? n : i, h ? n : u, s, f, d],
              m = r.apply(n, p);
            return _l(e) && zl(m, p), (m.placeholder = a), Pl(m, e, t);
          }
          function Ka(e) {
            var t = Se[e];
            return function (e, n) {
              if (((e = yo(e)), (n = null == n ? 0 : xn(go(n), 292)))) {
            ...
            if (
              (x &&
                (function (e, t) {
                  ...
                  if (c) {
                    var f = e[3];
                    (e[3] = f ? Oa(f, c, t[4]) : c), (e[4] = f ? cn(e[3], l) : t[4]);
                  }
                  (c = t[5]) &&
              ...
              (f = E[3]),
              (d = E[4]),
              !(m = E[9] = E[9] === n ? (g ? 0 : e.length) : bn(E[9] - v, 0)) &&
                24 & t &&
                (t &= -25),
              t && 1 != t)
            )
          ...
          function Qa(e, t, r, a) {
            return e === n || ($i(e, Pe[r]) && !De.call(a, r)) ? t : e;
          }
          ...
          function nl(e, t, r, a, l, i) {
            ...
            for (i.set(e, t), i.set(t, e); ++f < c; ) {
              var p = e[f],
                m = t[f];
              if (a) var g = o ? a(m, p, f, t, e, i) : a(p, m, f, e, t, i);
              if (g !== n) {
                if (g) continue;
                d = !1;
                break;
          ...
          var il = zn
            ...
            : sc;
          function ol(e) {
            for (var t = e.name + '', n = An[t], r = De.call(An, t) ? n.length : 0; r--; ) {
              var a = n[r],
                l = a.func;
          ...
          function ul() {
            var e = $n.iteratee || ic;
            return (e = e === ic ? Rr : e), arguments.length ? e(arguments[0], arguments[1]) : e;
          }
          function sl(e, t) {
            var n,
              r,
          ...
          function gl(e, t, n) {
            ...
            return l || ++r != a
              ? l
              : !!(a = null == e ? 0 : e.length) && eo(a) && bl(i, a) && (Hi(e) || Yi(e));
          }
          function vl(e) {
            return 'function' != typeof e.constructor || kl(e) ? {} : Wn(Ve(e));
          }
          function yl(e) {
            return Hi(e) || Yi(e) || !!(tt && e && e[tt]);
          }
          function bl(e, t) {
            var n = typeof e;
            return (
          ...
          ((Nn && ml(new Nn(new ArrayBuffer(1))) != P) ||
            (Cn && ml(new Cn()) != k) ||
            (Sn && ml(Sn.resolve()) != S) ||
            (On && ml(new On()) != j) ||
            (jn && ml(new jn()) != A)) &&
          ...
          function Hl(e, t, r) {
            ...
            var l = a - 1;
            return (
              r !== n && ((l = go(r)), (l = r < 0 ? bn(a + l, 0) : xn(l, a - 1))),
              Tt(e, ul(t, 3), l, !0)
            );
          }
          function Jl(e) {
          ...
          var oi = Zr(function (e, t) {
            ...
            ui = Zr(function (e) {
              var t = Zl(e);
              return Vi(t) && (t = n), ga(jt(e, Vi), ul(t, 2));
            }),
            si = Zr(function (e) {
              var t = Zl(e);
              return (t = 'function' == typeof t ? t : n), ga(jt(e, Vi), n, t);
            }),
            fi = Zr(li);
          ...
          var mi = rl(function (e) {
            ...
            return !(t > 1 || this.__actions__.length) && a instanceof Hn && bl(r)
              ? ((a = a.slice(r, +r + (t ? 1 : 0))).__actions__.push({
                ...
                new Yn(a, this.__chain__).thru(function (e) {
                  return t && !e.length && e.push(n), e;
                }))
              : this.thru(l);
          });
          var gi = Aa(function (e, t, n) {
          ...
          var Wi = Ua(Sr),
            ...
            Yi = Ar(
              ...
              ? Ar
              : function (e) {
                  return no(e) && De.call(e, 'callee') && !Ge.call(e, 'callee');
                },
            Hi = we.isArray,
            Ji = yt
              ? Kt(yt)
          ...
          function yo(e) {
            ...
            e = e.replace(le, '');
            var n = ge.test(e);
            return n || ye.test(e) ? ut(e.slice(2), n ? 2 : 8) : me.test(e) ? h : +e;
          }
          function bo(e) {
            return za(e, Po(e));
          }
          ...
          var Eo = Ma(function (e, t) {
              ...
              else for (var n in t) De.call(t, n) && nr(e, n, t[n]);
            }),
            _o = Ma(function (e, t) {
              za(t, Po(t), e);
            }),
          ...
          var Co = Zr(function (e, t) {
              ...
              for (l && xl(t[0], t[1], l) && (a = 1); ++r < a; )
                for (var i = t[r], o = Po(i), c = -1, u = o.length; ++c < u; ) {
                  var s = o[c],
                    f = e[s];
                  (f === n || ($i(f, Pe[s]) && !De.call(e, s))) && (e[s] = i[s]);
                }
              return e;
            }),
            So = Zr(function (e) {
              return e.push(n, el), kt(Ro, n, e);
            });
          function Oo(e, t, r) {
          ...
          var Jo = Da(function (e, t, n) {
              return e + (n ? '-' : '') + t.toLowerCase();
            }),
            Uo = Da(function (e, t, n) {
              return e + (n ? ' ' : '') + t.toLowerCase();
            }),
            Vo = Ra('toLowerCase');
          ...
          return (
              ...
              return l
                ? (r && 'number' != typeof r && xl(e, t, r) && ((r = 0), (a = l)),
                  (function (e, t, r, a) {
                    var l = e.length;
                    for (
                      (r = go(r)) < 0 && (r = -r > l ? 0 : l + r),
                        (a = a === n || a > l ? l : go(a)) < 0 && (a += l),
                        a = r > a ? 0 : vo(a);
                      r < a;
            ...
            ($n.flatMapDepth = function (e, t, r) {
              return (r = r === n ? 1 : go(r)), yr(ki(e, t), r);
            }),
            ($n.flatten = Jl),
            ...
            ($n.rest = function (e, t) {
              if ('function' != typeof e) throw new ze(r);
              return Zr(e, (t = t === n ? t : go(t)));
            }),
            ($n.reverse = ti),
            ($n.sampleSize = function (e, t, r) {
              return (t = (r ? xl(e, t, r) : t === n) ? 1 : go(t)), (Hi(e) ? Qn : Qr)(e, t);
            }),
            ...
            ($n.toPairsIn = $o),
            ($n.toPath = function (e) {
              return Hi(e) ? At(e, Bl) : uo(e) ? [e] : Ia(Dl(xo(e)));
            }),
            ($n.toPlainObject = bo),
            ...
            ($n.gte = qi),
            ($n.has = function (e, t) {
              return null != e && gl(e, t, Or);
            }),
            ($n.hasIn = jo),
            ($n.head = Ul),
            ($n.identity = lc),
            ($n.includes = function (e, t, n, r) {
              (e = Ui(e) ? e : Wo(e)), (n = n && !r ? go(n) : 0);
              var a = e.length;
              return (
                n < 0 && (n = bn(a + n, 0)),
            ...
            ($n.lastIndexOf = function (e, t, r) {
              ...
              var l = a;
              return (
                r !== n && (l = (l = go(r)) < 0 ? bn(a + l, 0) : xn(l, a - 1)),
                t == t
                  ? (function (e, t, n) {
            ...
            ($n.lte = ho),
            ($n.max = function (e) {
              return e && e.length ? gr(e, lc, Sr) : n;
            }),
            ($n.maxBy = function (e, t) {
              return e && e.length ? gr(e, ul(t, 2), Sr) : n;
            }),
            ($n.mean = function (e) {
              return qt(e, lc);
            }),
            ...
            ($n.min = function (e) {
              return e && e.length ? gr(e, lc, Tr) : n;
            }),
            ($n.minBy = function (e, t) {
              return e && e.length ? gr(e, ul(t, 2), Tr) : n;
            }),
            ($n.stubArray = vc),
            ($n.stubFalse = yc),
            ...
            ($n.repeat = function (e, t, r) {
              return (t = (r ? xl(e, t, r) : t === n) ? 1 : go(t)), Gr(xo(e), t);
            }),
            ($n.replace = function () {
              var e = arguments,
                t = xo(e[0]);
            ...
            ($n.size = function (e) {
              ...
              var t = ml(e);
              return t == k || t == j ? e.size : Dr(e).length;
            }),
            ($n.snakeCase = Ko),
            ...
            ($n.template = function (e, t, r) {
              ...
              var m = t.variable;
              m || (d = 'with (obj) {\n' + d + '\n}\n'),
                (d = (i ? d.replace(Y, '') : d).replace(H, '$1').replace(J, '$1;')),
                (d =
                  'function(' +
                  (m || 'obj') +
                  ') {\n' +
            ...
            ($n.toSafeInteger = function (e) {
              return e ? cr(go(e), -9007199254740991, d) : 0 === e ? e : 0;
            }),
            ($n.toString = xo),
            ...
            ($n.truncate = function (e, t) {
              ...
              if (to(t)) {
                ...
                (r = 'length' in t ? go(t.length) : r), (a = 'omission' in t ? sa(t.omission) : a);
              }
              var i = (e = xo(e)).length;
              if (an(e)) {
                var o = dn(e);
              ...
              l &&
                ($n.prototype[t] = function () {
                  ...
                  if (!i && s) {
                    t = m ? t : new Hn(this);
                    var g = e.apply(t, o);
                    return g.__actions__.push({ func: pi, args: [f], thisArg: n }), new Yn(g, d);
                  }
                  return p && m
                    ? e.apply(this, o)
            ...
            (Hn.prototype.value = function () {
              ...
              if (!n || (!r && a == c && h == c)) return ma(e, this.__actions__);
              var p = [];
              e: for (; c-- && d < h; ) {
        ...
        new Array(n)
          ...
          .map((e, t) =>
            l.default.createElement(
              ...
              l.default.createElement('div', { className: 'half-dialog', style: m(t) }),
              l.default.createElement(
                'svg',
                {
                  style: { color: r },
            ...
            l.default.createElement(
              ...
              (null === (r = null == e ? void 0 : e.children) || void 0 === r ? void 0 : r.length)
                ? '0' == e.children[0].height
                  ? l.default.createElement(we, null)
                  : l.default.createElement(je, null)
                : l.default.createElement('div', { style: { width: '12px', height: '12px' } }),
              l.default.createElement('span', { className: 'text' }, e.title),
            ),
    ...
    return l.default.createElement(
      ...
      l.default.createElement(
        ...
        l.default.createElement(Yt, {
          ...
          defaultValue: f,
          handleClick: () => {
            p(a ? (m && '100%' == h ? '0px' : '100%') : '0px' == h ? '100%' : '0px');
          },
          handleIptChange: (e) => {
            d(a ? e : '');
          },
  ...
  var an = t.memo((e) => {
    const { treeData: n, defaultOpen: r, avaDrop: a, checkCallback: i, dropCallback: o } = e,
      [c, u] = t.useState(n),
      [s, f] = t.useState('');
    t.useEffect(() => {
      d(c, 1, null);
    ...
    const d = (e, t, n) => {
      ...
      m = t.useCallback(
        (e) => {
          var t;
          if (e.disabled) return l.default.createElement('div', { className: 'disblaed-checkBox' });
          if (!(null === (t = null == e ? void 0 : e.children) || void 0 === t ? void 0 : t.length))
            return e.checked
              ? l.default.createElement(
                  'div',
                ...
                if (a == r.children.length - 1)
                  return t.every((e) => 0 == e)
                    ...
                    : l.default.createElement(
                        ...
                        l.default.createElement('div', { className: 'less-box' }),
                      );
              }
            };
            return n(e);
            ...
            return l.default.createElement(
              ...
              l.default.createElement(
                'div',
                {
                  ...
                  onDragOver: (t) =>
                    ((e, t) => {
                      if (a && (e.nativeEvent.preventDefault(), t.title && t.title !== s)) {
                        f(t.title);
                        const e = [...c],
                          n = (e) => {
                            var r;
                ...
                (null === (r = null == e ? void 0 : e.children) || void 0 === r ? void 0 : r.length)
                  ? '0' == e.children[0].height
                    ? l.default.createElement(we, { onClick: () => h(e) })
                    : l.default.createElement(je, { onClick: () => h(e) })
                  : l.default.createElement('div', { style: { width: '14px', height: '14px' } }),
                m(e),
                l.default.createElement(
                  'span',
                  {
    ...
    return l.default.createElement(
      t.Fragment,
      null,
      l.default.createElement('div', { className: 'tree-select-dialog' }, g(c)),
    );
  });
  var ln = t.memo((e) => {
    const {
    ...
    const h = t.useMemo(
        () =>
          a
            ? l.default.createElement('div', { className: 'disblaed-checkBox' })
            : u
            ? l.default.createElement(
                'div',
        ...
        ? l.default.createElement(
            ...
            i.map((e, t) =>
              l.default.createElement(
                ...
                p(e),
                l.default.createElement('div', { className: 'text' }, e.label),
              ),
            ),
          )
        : l.default.createElement(
            ...
            h,
            l.default.createElement('div', { className: 'text' }, n),
          ),
    );
  });
  const on = {
  ...
  var cn = t.memo((e) => {
    ...
    const [s, f] = t.useState(n),
      [d, h] = t.useState(n),
      [p, m] = t.useState(r),
      [g, v] = t.useState('0.2s linear'),
      [y, b] = t.useState(on[n.length]),
      [x, E] = t.useState({
        leftPic: {
          pos: { left: 0 },
          width: r / 2 + 'px',
    ...
    t.useEffect(() => {
      ...
      t.useEffect(
        () => (
          i && (u ? requestAnimationFrame(S) : requestAnimationFrame(C)),
          () => {
    ...
    return l.default.createElement(
      ...
      u
        ? l.default.createElement(
            'div',
            { className: 'card-swiper', style: { height: a + 'px', width: 2 * r + 'px' } },
            l.default.createElement(
              'div',
              { className: 'center-pic', style: { width: 2 * r - 40 + 'px', height: a + 'px' } },
        ...
        : l.default.createElement(
            'div',
            { className: 'swipers', style: { width: r + 'px', height: a + 'px' } },
            l.default.createElement(
              'div',
              {
                className: 'swiperList',
                style: { right: p + 'px', transition: g, width: r * s.length + 'px' },
              },
              s.map((e, t) =>
                l.default.createElement('img', {
                  key: t,
                ...
                onClick: () => {
                  p <= 0
                    ? (v(''),
                      m((s.length - 2) * r),
                      setTimeout(() => {
                        v('0.2s linear'), m((s.length - 2) * r - r);
                      }, 0))
                    : m(p - r);
                },
              },
              l.default.createElement(pt, null),
            ),
            l.default.createElement(
              'div',
              {
              ...
              l.default.createElement(Ct, null),
            ),
            c &&
              l.default.createElement(
                'div',
    ...
    return l.default.createElement(
              ...
              if (m) {
                ...
                v &&
                  e.nativeEvent.target.scrollHeight -
                    ...
                    0 &&
                  setTimeout(() => {
                    O((e) => ((e = [...e, ...i.slice(e.length + 1, e.length + 11)]), [...e]));
                  }, 300);
            })(e),
          ref: T,
        },
          ...
          !m &&
            l.default.createElement(
              ...
              l.default.createElement(
                'tr',
                null,
                (c || u) && l.default.createElement('th', { style: { textAlign: o || 'left' } }),
                s &&
                  l.default.createElement(
                    'th',
                    { style: { textAlign: o || 'left' } },
                    l.default.createElement(ln, {
                      checked: z.length == S.length,
                      checkCallback: (e) => Y(e),
                    }),
                  ),
                N.map((e, t) =>
                  l.default.createElement(
                    ...
                    l.default.createElement(
                      ...
                      l.default.createElement('span', null, e.title),
                      (null == e ? void 0 : e.sorter) &&
                        p &&
                        l.default.createElement(
                          'div',
                          { className: 'sort-icon' },
                          l.default.createElement(Ae, {
                            onClick: () => H(t, e, 2),
                            style: K(e, 0),
                          }),
                          l.default.createElement(we, {
                            onClick: () => H(t, e, 3),
                            style: K(e, 1),
                          }),
                        ),
                      (null == e ? void 0 : e.filter) &&
                        ...
                        l.default.createElement(
                          un,
                          {
                            ...
                            dialogWidth: 130,
                            noBorder: !0,
                            content: l.default.createElement(
                              'div',
                              ...
                              l.default.createElement(
                                ...
                                l.default.createElement(Lt, null),
                              ),
                            ),
                          },
                          l.default.createElement(
              ...
              ? l.default.createElement(
                  ...
                  l.default.createElement(
                    ...
                    l.default.createElement(
                      ...
                      null,
                      (c || u) &&
                        l.default.createElement('th', { style: { textAlign: o || 'left' } }),
                      s &&
                        l.default.createElement(
                          'th',
                          { style: { textAlign: o || 'left' } },
                  ...
                  l.default.createElement('tbody', null, G()),
                )
              : v || y
              ? l.default.createElement(
                  'tbody',
      ...
      y &&
        l.default.createElement(
          ...
          l.default.createElement(Wt, {
            style: Z,
            total: i.length,
            showSizeChanger: !0,
            pageSizeOptions: x || fn,
            showJumpInput: !0,
            changePageSizeCallback: (e) => {
              R(e), O((t) => ((t = i.slice(0, e)), [...t])), _ && _(e, i.slice(0, e));
            },
            changePageCallback: (e) => {
              B(e),
                O((t) => ((t = i.slice((e - 1) * L, (e - 1) * L + L)), [...t])),
  ...
  var gn = t.memo((e) => {
    const { children: n, header: r, disabled: a = !1, listKey: i, extra: o } = e,
      [c, u] = mn(0),
      [s, f] = mn(!1),
      {
        activeKeyList: d,
          ...
          'left' == m
            ? l.default.createElement(
                ...
                l.default.createElement(
                  ...
                  l.default.createElement('div', { className: 'header-text' }, r),
                ),
                o && l.default.createElement('div', { className: 'right' }, o),
              )
            : 'right' == m
            ? l.default.createElement(
                'div',
                ...
                l.default.createElement(
                  ...
                  l.default.createElement(
                    ...
                    { className: 'header-icon' },
                    '0px' == b.maxHeight
                      ? l.default.createElement(Ce, null)
                      : l.default.createElement(we, null),
                  ),
                ),
              )
            ...
            ? l.default.createElement(
                ...
                l.default.createElement('div', { className: 'right' }, o),
              )
            : void 0,
        [m, b, a],
      );
  ...
  var yn = t.memo((e) => {
    ...
    return l.default.createElement(
      vn.Provider,
      { value: a },
      l.default.createElement('div', { className: 'avatar-group' }, t),
    );
  });
  var bn = t.memo((e) => {
    const {
    ...
    return l.default.createElement(
      ...
      n && 'img' === n.type
        ? n
        : l.default.createElement('div', { ref: d, className: 'text-ref' }, n),
      'button' === c &&
        u &&
        l.default.createElement('div', { className: 'button-dialog', style: m, onClick: g }, u),
      'mask' === c &&
        u &&
        l.default.createElement(
          'div',
          { className: 'dialog' },
          l.default.createElement('div', { className: 'icon', onClick: g }, u),
        ),
    );
  });
  var xn = t.memo((e) => {
      ...
      n
        ? l.default.createElement(
            ...
            c
              ...
              : s
              ? l.default.createElement('span', { className: 'badge-text' }, s)
              : l.default.createElement(
                  'span',
  ...
  var En = t.memo((e) => {
    ...
    return l.default.createElement('div', { className: 'list-item', style: i }, n);
  });
  const _n = t.createContext({}),
    wn = l.default.forwardRef((e) => {
      const {
          style: n = {},
          dataSource: r,
          render: a,
      ...
      t.useEffect(() => {
        ...
        if (c && u) m((e) => ((e = r.slice(0, u)), [...e]));
          ...
          (y.current = t), m((e) => ((e = r.slice(0, f + 2)), [...e]));
        }
      }, []);
      const E = t.useMemo(() => {
          const e = {};
      ...
      return l.default.createElement(
        ...
        l.default.createElement(
          ...
          l.default.createElement('div', { className: 'list-header', style: E }, i),
          s
            ? l.default.createElement(
                'div',
                {
                  ...
                  onScroll: () => {
                    ...
                    v(x.current.scrollTop), m((t) => ((t = r.slice(e, e + f + 2)), [...t]));
                  },
                },
                l.default.createElement(
                  'div',
  ...
  (wn.Item = En), (wn.displayName = 'List');
  let kn,
    Nn = 0,
    Cn = 0;
  function Sn(e, t) {
    ...
    'object' == typeof t
      ? ((r = t.style || {}),
        (a = t.duration || 3e3),
        (n = t.content),
        (i = t.position ? t.position : 'top'),
        (c = !!t.clearable && t.clearable))
      : 'string' == typeof t && (n = t);
    const u = document.createElement('div'),
      s = String(Math.floor(1e3 * Math.random()));
    u.setAttribute('class', `${i}-${s}`),
      kn ||
        ((kn = document.createElement('div')),
        kn.setAttribute('class', 'all-container'),
        document.body.appendChild(kn)),
      kn.appendChild(u),
      setTimeout(() => {
        Array.prototype.slice.call(null == kn ? void 0 : kn.childNodes).includes(u) &&
          (On(Array.prototype.slice.call(null == kn ? void 0 : kn.childNodes), i),
          null == kn || kn.removeChild(u),
          'top' === i ? Nn-- : Cn--);
      }, a + 200),
      o.default.render(
        l.default.createElement(jn, {
          style: r,
          content: n,
          type: e,
          duration: a,
  ...
  const jn = (e) => {
    ...
    t.useEffect(() => {
      ...
      t.useEffect(() => {
        const e = o || 'top';
        (null == d ? void 0 : d.current).style[e] = 70 * ('top' === e ? Nn : Cn) + 'px';
      }, [Nn, Cn]);
    const h = t.useMemo(
      () =>
        'info' === a
          ? l.default.createElement(lt, { style: { color: '#1890ff', fontSize: '16px' } })
          : 'error' === a
          ? l.default.createElement($e, { style: { color: '#f53f3f', fontSize: '16px' } })
          : 'normal' === a
          ? l.default.createElement(l.default.Fragment, null)
          : 'success' === a
          ? l.default.createElement(Le, { style: { color: '#19b42a', fontSize: '16px' } })
          : 'warning' === a
          ? l.default.createElement(lt, { style: { color: '#fa7d00', fontSize: '16px' } })
          : 'loading' === a
          ? l.default.createElement(xt, { style: { color: '#1890ff', fontSize: '16px' } })
          : void 0,
      [a],
    );
    return l.default.createElement(
      ...
      h,
      l.default.createElement('span', { className: 'toast-content' }, r),
      c &&
        l.default.createElement(Ye, {
          onClick: () => {
            !(function (e, t) {
              ...
              for (let a in r)
                if (r[a].getAttribute('class') === `${t}-${e}`) {
                  const e = r[a];
                  null == n || n.removeChild(e),
                    'top' === t ? Nn-- : Cn--,
                    On(r.slice(Number(a)), t);
                }
            })(u, o);
          },
        }),
  ...
  let In;
  (jn.info = (e) => Sn('info', e)),
    (jn.success = (e) => Sn('success', e)),
    (jn.error = (e) => Sn('error', e)),
    (jn.normal = (e) => Sn('normal', e)),
    (jn.warning = (e) => Sn('warning', e)),
    (jn.loading = (e) => Sn('loading', e));
  let zn = 0,
    An = 0,
    Mn = 0,
    Pn = 0;
  function Ln(e, t) {
    ...
    'object' == typeof t
      ? ((i = t.title),
        ...
        (c = t.content),
        (n = t.doneCallback),
        (u = t.position ? t.position : 'topRight'),
    ...
    h.setAttribute('class', `${u}-${p}`),
      In ||
        ...
        In.setAttribute('class', 'notification-container'),
        document.body.appendChild(In)),
      In.appendChild(h),
      setTimeout(() => {
        Array.prototype.slice.call(null == In ? void 0 : In.childNodes).includes(h) &&
          (Dn(Array.prototype.slice.call(null == In ? void 0 : In.childNodes), u),
          null == In || In.removeChild(h),
          'topLeft' === u
            ? zn--
            : 'topRight' === u
            ? An--
  ...
  function Dn(e, t) {
    ...
    for (let t in e) {
      const l = e[t].childNodes[0];
      if (null === (n = e[t].getAttribute('class')) || void 0 === n ? void 0 : n.startsWith(a)) {
        const e =
  ...
  const Bn = (e) => {
    ...
    t.useEffect(() => {
      ...
      t.useEffect(() => {
        let e;
        e = (null == u ? void 0 : u.startsWith('top')) ? 'top' : 'bottom';
        let t,
          n = 0;
        'topLeft' === u && zn >= 1
          ? ((n = v.current.clientHeight * (zn - 1)), (t = zn))
          : 'topRight' === u && An >= 1
          ? ((n = v.current.clientHeight * (An - 1)), (t = An))
          : 'bottomLeft' === u && Mn >= 1
          ? ((n = v.current.clientHeight * (Mn - 1)), (t = Mn))
          : 'bottomRight' === u && Pn >= 1 && ((n = v.current.clientHeight * (Pn - 1)), (t = Pn)),
          ((null == v ? void 0 : v.current).style[e] = 30 * t + n + 'px');
      }, [zn, An, Mn, Pn]);
    const y = t.useMemo(
        () =>
          'info' === i
            ? l.default.createElement(lt, { style: { color: '#1890ff', fontSize: '24px' } })
            : 'error' === i
            ? l.default.createElement($e, { style: { color: '#f53f3f', fontSize: '24px' } })
            : 'normal' === i
            ? l.default.createElement(l.default.Fragment, null)
            : 'success' === i
            ? l.default.createElement(Le, { style: { color: '#19b42a', fontSize: '24px' } })
            : 'warning' === i
            ? l.default.createElement(lt, { style: { color: '#fa7d00', fontSize: '24px' } })
            : 'loading' === i
            ? l.default.createElement(xt, { style: { color: '#1890ff', fontSize: '24px' } })
            : void 0,
        [i],
      ),
      b = t.useMemo(
        () => ((null == u ? void 0 : u.includes('Left')) ? { left: '20px' } : { right: '20px' }),
        [u],
      );
    return l.default.createElement(
      'div',
      {
        ...
        style: Object.assign(Object.assign({ opacity: m }, b), n),
        ref: v,
      },
      l.default.createElement(
        'div',
        ...
        l.default.createElement(
          ...
          y,
          l.default.createElement('span', { className: 'title-content' }, r),
        ),
        s &&
          l.default.createElement(Ye, {
            className: 'close-icon',
      ...
      l.default.createElement('div', { className: 'notification-content' }, a),
      f &&
        l.default.createElement(
          'div',
  ...
  (Bn.info = (e) => Ln('info', e)),
    (Bn.success = (e) => Ln('success', e)),
    (Bn.error = (e) => Ln('error', e)),
    (Bn.normal = (e) => Ln('normal', e)),
    (Bn.warning = (e) => Ln('warning', e)),
    (Bn.loading = (e) => Ln('loading', e)),
    (e.Affix = Vt),
    (e.Avatar = bn),
    (e.AvatarGroup = yn),
    (e.Badge = xn),
    ...
    (e.Loading = (e) => {
      ...
      return l.default.createElement(
        t.Fragment,
        null,
        r && l.default.createElement('div', { className: 'dialog' }),
        'default' === n
          ? l.default.createElement(
              'div',
              ...
              a && l.default.createElement('div', { className: 'text' }, a),
            )
          : l.default.createElement(
              'div',
              ...
              new Array(3)
                .fill('')
                .map((e, t) =>
                  l.default.createElement('div', { className: f === t ? 'dot-active' : 'dot' }, e),
                ),
            ),
      );
    }),
